...
document.head.appendChild(
  ...
  bpExtraStyle.textContent = `
    ...
    .bp-small-upgrade-modal{position:relative;width:min(390px,calc(100vw - 28px));background:#fff;border:1px solid #ece7f5;border-radius:18px;padding:16px;box-sizing:border-box;box-shadow:0 24px 70px rgba(15,23,42,.22);font-family:system-ui,-apple-system,sans-serif}
    ...
    .bp-small-upgrade-fields{display:grid;grid-template-columns:1fr 1fr;gap:7px;margin-top:12px}
    ...
    .bp-small-upgrade-textarea{min-height:48px;resize:vertical}
    .bp-small-upgrade-actions{display:flex;justify-content:flex-end;gap:6px;margin-top:9px}
    .bp-small-upgrade-actions .bp-airo-btn{padding:7px 10px!important;font-size:10px!important;border-radius:8px}
    @media(max-width:520px){.bp-small-upgrade-fields{grid-template-columns:1fr}.bp-small-upgrade-modal{width:min(360px,calc(100vw - 20px));padding:14px}}
  `;
